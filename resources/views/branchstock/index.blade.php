...
@section('breadcrumb')
    @parent
    <li class="active">Branch Stock Management</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="btn-group">
                    <button onclick="addForm('{{ route('branch.store') }}')" class="btn btn-success  btn-flat"><i class="fa fa-plus-circle"></i> Manage Stock</button>
